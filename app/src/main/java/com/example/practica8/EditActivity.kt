            ...
            override fun onResponse(call: Call<Boolean>, response: Response<Boolean>) {
                if (response.isSuccessful) {
                    ...
                    if (res != null && res) {
                        ...
                        Toast.makeText(this@EditActivity, "Se modificó correctamente", Toast.LENGTH_LONG).show()
                        finish()
                    } else {
                        Toast.makeText(this@EditActivity, "Error al modificar el contacto", Toast.LENGTH_LONG).show()
                    }
                } else {
                    Toast.makeText(this@EditActivity, "Error en la respuesta del servidor", Toast.LENGTH_LONG).show()
                }
            }
            ...
            override fun onResponse(call: Call<Boolean>, response: Response<Boolean>) {
                if (response.isSuccessful) {
                    ...
                    if (res != null && res) {
                        ...
                        Toast.makeText(this@EditActivity, "Contacto eliminado", Toast.LENGTH_LONG).show()
                        finish()
                    } else {
                        Toast.makeText(this@EditActivity, "Error al eliminar el contacto", Toast.LENGTH_LONG).show()
                    }
                } else {
                    Toast.makeText(this@EditActivity, "Error en la respuesta del servidor", Toast.LENGTH_LONG).show()
                }
